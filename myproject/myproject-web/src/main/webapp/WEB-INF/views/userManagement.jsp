...
<html>
  <head>  
    ...
    <style>
     ...
     <link href="<c:url value='/static/css/user_app.css'/>" rel="stylesheet"></link>
  </head>
  <body ng-app="myApp" class="ng-cloak">
      ...
      <script src="<c:url value='/static/js/angular-js/1.4.4/angular.min.js' />"></script>
      <script src="<c:url value='/static/js/angular-js/1.4.4/angular-resource.min.js' />"></script>
      <script src="<c:url value='/static/js/user_app.js' />"></script>
      <script src="<c:url value='/static/js/angular-js/service/user_service.js' />"></script>
      <script src="<c:url value='/static/js/angular-js/controller/user_controller.js' />"></script>
  </body>
</html>